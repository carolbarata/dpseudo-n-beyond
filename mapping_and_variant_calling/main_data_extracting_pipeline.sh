...
##################################################
# Script that uses bcftools to extract relevant
# variant data information from VCF file and 
# extract the total number of SNPs called
##################################################
