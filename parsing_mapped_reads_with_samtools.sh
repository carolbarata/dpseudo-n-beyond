...
BAMFILE=${OUTDIR}${SAMPLENAME}/${SAMPLENAME}_temp.bam
MATE_BAMFILE=${OUTDIR}${SAMPLENAME}/${SAMPLENAME}_temp.fixmate.bam
FIX_BAMFILE=${OUTDIR}${SAMPLENAME}/${SAMPLENAME}_temp.nounmap.bam
NODUP_BAMFILE=${OUTDIR}${SAMPLENAME}/${SAMPLENAME}_temp.nodup.bam
SORTED_BAMFILE=${OUTDIR}${SAMPLENAME}/${SAMPLENAME}_temp.sorted.bam
GROUP_BAMFILE=${OUTDIR}${SAMPLENAME}/${SAMPLENAME}_temp.groupinfo.bam
INTERVALS_FILE=${OUTDIR}${SAMPLENAME}/${SAMPLENAME}_temp.intervals
REALBAMFILE=${OUTDIR}${SAMPLENAME}/${SAMPLENAME}_temp.realign.bam
FINBAMFILE=${OUTDIR}${SAMPLENAME}/${SAMPLENAME}${FINBAMEXT}
IDXSTATS_FILE=${OUTDIR}${SAMPLENAME}/${SAMPLENAME}${IDXEXT}
STATS_FILE=${OUTDIR}${SAMPLENAME}/${SAMPLENAME}${STATSEXT}
FLAGSTAT_FILE=${OUTDIR}${SAMPLENAME}/${SAMPLENAME}${FLAGEXT}
COV_FILE=${OUTDIR}${SAMPLENAME}/${SAMPLENAME}${COVEXT}
